...
* content
{:toc}
<div class="postImg" style="background-image:url(http://ovl1kjv88.bkt.clouddn.com/media/nginx-thumbnail.png)"></div>
...
们访问墙外服务器server的网页请求，代理到一个可以访问该网站的代理服务器proxy，这个代理服务器proxy把墙外服务器server上的网页内容获取，再转发给客户。具体的流程如下图。
    ![](http://ovl1kjv88.bkt.clouddn.com/media/1661ac31c06b0681.jpeg)
...
2. **反向代理**
    ...
    反向代理则正好相反，先看流程图图。
    ![](http://ovl1kjv88.bkt.clouddn.com/media/1661ac31c192d22f.jpeg)
...
2. **解决跨域**
    ...
    ![](http://ovl1kjv88.bkt.clouddn.com/media/1661ac31c1944c05.jpeg)
...
3. **适配PC与移动环境**
    ...
    ![](http://ovl1kjv88.bkt.clouddn.com/media/1661ac31c1a18887.gif)
...
4. **合并请求**
    ...
    ![](http://ovl1kjv88.bkt.clouddn.com/media/1661ac31c0b189ea.jpeg)
    ...
    ![](http://ovl1kjv88.bkt.clouddn.com/media/1661ac31c27214fa.jpeg)
...
5. **图片处理**
    ...
    ```
    ![](http://ovl1kjv88.bkt.clouddn.com/media/1661ac31eb85e6f4.gif)
...
6. **页面内容修改**
    ...
    ```
    ![](http://ovl1kjv88.bkt.clouddn.com/media/1661ac31f0d611ca.gif)
